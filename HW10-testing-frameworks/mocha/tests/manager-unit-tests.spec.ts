...
describe('Manager Class', () => {
    ...
    beforeEach(() => {
        manager = new Manager(true, true, 'Bill', 120000);
    });
    ...
    it('should throw an error when getting salary if not employed', () => {
        manager = new Manager(false, true, 'Bob', 120000);
    ...
    it('should return the correct description when not employed', () => {
        manager = new Manager(false, true, 'Charlie', 110000);
    ...
    it('should return no duties when not employed', () => {
        manager = new Manager(false, false, 'Dana', 115000);
    ...
    it('should return base salary when not bonus eligible', () => {
        manager = new Manager(true, false, 'Eve', 130000);
